...
describe("Event Handler Factories", () => {
	...
	describe("createAccelHandler", () => {
		...
		// Spot-check DOM wiring at high-g where the epsilon guard would fire.
		// Full range coverage is in relativity_lib.test.ts (fuel mass calculation suite).
		it("reports fuel mass in masses (not tons) for 10g and 365 proper days", async () => {
			const accelInput = document.createElement("input");
			accelInput.value = "10";
			const timeInput = document.createElement("input");
			timeInput.value = "365";
	...
	describe("createFlipBurnHandler", () => {
		...
		// Spot-check DOM wiring at high-g where the epsilon guard would fire.
		// Full range coverage is in relativity_lib.test.ts (fuel mass calculation suite).
		it("reports fuel mass in masses (not tons) for 10g and 4 light years", async () => {
			const accelInput = document.createElement("input");
			accelInput.value = "10";
			const distanceInput = document.createElement("input");
